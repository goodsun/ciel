<?php require_once __DIR__ . '/../src/auth.php'; global $CURRENT_LANG; ?>
  <header style="margin-bottom:32px;padding-bottom:16px;border-bottom:1px solid var(--border, rgba(255,255,255,0.06));">
