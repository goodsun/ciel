...
/* Model selector */
.model-selector { display: flex; gap: 4px; margin-bottom: 24px; overflow-x: auto; -webkit-overflow-scrolling: touch; scrollbar-width: thin; padding-bottom: 6px; }
.model-selector::-webkit-scrollbar { height: 4px; }
.model-selector::-webkit-scrollbar-track { background: transparent; }
.model-selector::-webkit-scrollbar-thumb { background: #3a3a5a; border-radius: 2px; }
