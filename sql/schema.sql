...
CREATE TABLE jobs (
    ...
    cost_runpod     DECIMAL(10, 6)  DEFAULT NULL COMMENT 'RunPod actual cost USD (confirmed after reconciliation)',
    cost_user       DECIMAL(10, 6)  DEFAULT NULL COMMENT 'cost_runpod * MARGIN_RATE (confirmed)',
    est_cost_runpod DECIMAL(10, 6)  DEFAULT NULL COMMENT 'Estimated RunPod cost USD (set on completion)',
    est_cost_user   DECIMAL(10, 6)  DEFAULT NULL COMMENT 'Estimated user cost USD (set on completion)',
...
CREATE TABLE endpoints (
    ...
    est_cost_per_sec DECIMAL(12,10) NOT NULL DEFAULT 0 COMMENT 'Estimated cost USD/sec from billing data',
    is_active        TINYINT(1)     NOT NULL DEFAULT 1,
    created_at       DATETIME       NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at       DATETIME       NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- reconcile_log: removed, now written to logs/reconcile.jsonl
